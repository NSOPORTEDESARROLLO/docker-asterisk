...
RUN         apt-get -y install wget build-essential  git-core subversion \
            ...
            uuid-dev libmysqlclient-dev unzip 



#Descargar el fuente de asterisk 
RUN         wget -P /usr/src "https://downloads.asterisk.org/pub/telephony/asterisk/old-releases/asterisk-11.25.3.tar.gz"; \
            tar -xzvf /usr/src/asterisk-11.25.3.tar.gz -C /usr/src/
            


WORKDIR     /usr/src/asterisk-11.25.3
...
RUN         ./configure --prefix=/opt/asterisk; \
            ...
            menuselect/menuselect --enable app_skel menuselect.makeopts; \
            /usr/src/asterisk-11.25.3/contrib/scripts/get_mp3_source.sh; \
            #echo -e "yes" | /usr/src/asterisk-11.25.3/contrib/scripts/get_ilbc_source.sh
...
RUN		    apt-get update; apt-get -y upgrade; \
            ...
            libavahi-client3 libavahi-common-data libavahi-common3 libbsd0 libcairo2 libcap-ng0 libcfg4 libcgi-fast-perl \
            libcgi-pm-perl libclass-c3-perl libclass-c3-xs-perl libcoroipcc4 libcpan-meta-perl libcpg4 libcups2 libcurl3 \
            libcurl3-gnutls libdata-optlist-perl libdata-section-perl libdatrie1 libdbus-1-3 libdns-export100 libedit2 \
            libexpat1 libfcgi-perl libflac8 libfontconfig1 libfreeradius-client2 libfreetype6 libgdbm3 libgdk-pixbuf2.0-0 \
            libgdk-pixbuf2.0-common libglib2.0-0 libglib2.0-data libgmime-2.6-0 libgomp1 libgpgme11 libgraphite2-3 libgsm1 \
            libgssapi-krb5-2 libgtk2.0-0 libgtk2.0-bin libgtk2.0-common libharfbuzz0b libical1a libidn11 libiksemel3 \
            libirs-export91 libisc-export95 libisccfg-export90 libjack-jackd2-0 libjasper1 libjbig0 libjpeg62-turbo libk5crypto3 \
            ...
            libpango-1.0-0 libpangocairo-1.0-0 libpangoft2-1.0-0 libparams-util-perl libpci3 libperl5.20 libpixman-1-0 \
            libpj2 libpjlib-util2 libpjmedia-audiodev2 libpjmedia-codec2 libpjmedia-videodev2 libpjmedia2 libpjnath2 \
            libpjsip-simple2 libpjsip-ua2 libpjsip2 libpjsua2 libpng12-0 libpod-latex-perl libpod-readme-perl libpopt0 \
            libportaudio2 libpq5 libpth20 libregexp-common-perl libresample1 librtmp1 libsamplerate0 libsasl2-2 \
            libsasl2-modules libsasl2-modules-db libsensors4 libsndfile1 libsnmp-base libsnmp30 libsoftware-license-perl \
            libsox-fmt-alsa libsox-fmt-base libsox2 libspandsp2 libspeex1 libspeexdsp1 libsqlite0 libsqlite3-0 libsrtp0 \
            libssh2-1 libssl1.0.0 libsub-exporter-perl libsub-install-perl libsybdb5 libterm-ui-perl libtext-soundex-perl \
